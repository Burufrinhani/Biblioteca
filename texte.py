...
("O Legado dos Reinos", 400, "Fantasia", "Em um mundo onde a magia foi esquecida, um jovem descobre que é o herdeiro de um antigo reino encantado. Ele deve embarcar em uma jornada perigosa para restaurar a magia e derrotar as forças das trevas que ameaçam dominar o mundo.", 44.90),

("A Filha dos Elementos", 350, "Fantasia", "Uma garota com poderes misteriosos é a única esperança para restaurar o equilíbrio entre os quatro elementos: terra, fogo, ar e água. Ela precisa dominar suas habilidades e enfrentar uma antiga profecia para salvar o mundo da destruição iminente.", 34.90),
